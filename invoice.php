...
if (!empty($result)) {
    ...
    //$body_msg = 'Your quote from Waggin Wheels has been reviewed and accepted. Ensure you pay by the date stated in the invoice. Here are the invoice details: https://f30d-121-6-10-155.ngrok-free.app/Pet-Transport-Booking-System/invoice.php?quote_id=';

    // $sid    = "ACa8bd31122a50ac8ddb1f4b4fbe20ac03";
    // $token  = "8416128f5e3ee8242cb13ae725765226";
