        ...
        <div class="container col-xxl-10 px-4 py-2">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="images/homepagepets.png" class="d-block mx-lg-auto img-fluid" width="700" height="500"
                        loading="lazy">
                </div>
                <div class="col-lg-6">
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <svg class="bd-placeholder-img" width="100%" height="70%" aria-hidden="true"
                ...
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p class="text3">- Kumar Rajesh, Member since 2019</p>
                        </p>
                    </div>
                </div>
            </div>
