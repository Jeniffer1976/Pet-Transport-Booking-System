    ...
    <nav class="navbar sticky-top navbar-expand-lg">
        ...
        <?php } else { ?>
            <nav class="navbar sticky-top navbar-expand-lg" style='height: 5em;'>
                <div class="m-0 order-0 order-md-1 position-absolute main-logo"
                    style="margin-left: 20px !important; margin-top: 5px !important">
                <?php } ?>
                <?php if ($role != 'admin') { ?>
                    ...
                    <li class="nav-item">
                        <?php if (isset($_SESSION['username'])) { ?> <!-- if user is logged in -->
                            <button type="button" class="btn btn-outline-danger rounded-pill mt-2 me-2"
                                onclick="location.href = '?logout'">Sign Out <i
                                    class="fas fa-sign-out-alt ms-2"></i></button>

                        <?php } else { ?>
                            <button type="button" class="btn btn-outline-success rounded-pill mt-2 me-2"
                                onclick="document.location='signIn.php'">Sign In <i
                    ...
                    if (isset($_SESSION['username'])) {
                        if ($role == 'admin') {
                            ...
                            <li class="nav-item" style='margin-top: 5%; color: #1E53B3'>
                                <span
                                    style='font-size: 1.05em; font-weight: 600; font-family: "Nunito"; letter-spacing: 1px'>Hi,
                    ...
                    <li class="nav-item dropdown">
                        ...
                        if ($role != 'admin') { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <?php } else { ?>
                                    <li><a class="dropdown-item" href="signIn.php">Sign In <i
                ...
                if ($role != 'admin') {
                    if (isset($_SESSION['username'])) {
                        ...
                        <div class="notification">
                            ...
                            $notiStatus = mysqli_query($link, $notiQuery) or die(mysqli_error($link));
